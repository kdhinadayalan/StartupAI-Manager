    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div>
        <h1 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
          <Settings className="w-5 h-5 text-brand-500 dark:text-brand-400" />
      ...
      <Card>
        ...
        {currentWorkspace.description && (
          <div className="mt-4 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/20 border border-slate-200 dark:border-slate-800/60">
            <span className="text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[10px] font-semibold block mb-1">
              Mission / Description
            </span>
