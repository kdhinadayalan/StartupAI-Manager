    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl relative z-10 backdrop-blur-xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">StartupAI Manager</h1>
          <p className="text-xs text-slate-400 mt-1">Autonomous Multi-Agent Startup Operating System</p>
        </div>
